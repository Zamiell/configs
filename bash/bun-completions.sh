...
# This file was generated on Ubuntu WSL using bun v1.3.12 with:
# bun completions --bash > bun-completions.sh
# It cannot be generated on a normal Windows Git Bash terminal because of this bug:
# https://github.com/oven-sh/bun/issues/25042
# It might have to be updated when new versions of bun come out.
