...
if is-james; then
  ...
  if [[ -f "$SSH_PRIVATE_KEY_PATH_PERSONAL_DST" ]] && cmp --silent "$SSH_PRIVATE_KEY_PATH_PERSONAL_SRC" "$SSH_PRIVATE_KEY_PATH_PERSONAL_DST"; then
    echo "The \"$SSH_PRIVATE_KEY_PATH_PERSONAL_DST\" file is already up to date."
  else
    cp "$SSH_PRIVATE_KEY_PATH_PERSONAL_SRC" "$SSH_PRIVATE_KEY_PATH_PERSONAL_DST"
    chmod 600 "$SSH_PRIVATE_KEY_PATH_PERSONAL_DST"
  ...
  if [[ -f "$SSH_PUBLIC_KEY_PATH_PERSONAL_DST" ]] && cmp --silent "$SSH_PUBLIC_KEY_PATH_PERSONAL_SRC" "$SSH_PUBLIC_KEY_PATH_PERSONAL_DST"; then
    echo "The \"$SSH_PUBLIC_KEY_PATH_PERSONAL_DST\" file is already up to date."
  else
    cp "$SSH_PUBLIC_KEY_PATH_PERSONAL_SRC" "$SSH_PUBLIC_KEY_PATH_PERSONAL_DST"
  ...
  if [[ $PERSONAL == "false" ]]; then
    ...
    if [[ -f "$SSH_PRIVATE_KEY_PATH_WORK_DST" ]] && cmp --silent "$SSH_PRIVATE_KEY_PATH_WORK_SRC" "$SSH_PRIVATE_KEY_PATH_WORK_DST"; then
      echo "The \"$SSH_PRIVATE_KEY_PATH_WORK_DST\" file is already up to date."
    else
      cp "$SSH_PRIVATE_KEY_PATH_WORK_SRC" "$SSH_PRIVATE_KEY_PATH_WORK_DST"
      chmod 600 "$SSH_PRIVATE_KEY_PATH_WORK_DST"
    ...
    if [[ -f "$SSH_PUBLIC_KEY_PATH_WORK_DST" ]] && cmp --silent "$SSH_PUBLIC_KEY_PATH_WORK_SRC" "$SSH_PUBLIC_KEY_PATH_WORK_DST"; then
      echo "The \"$SSH_PUBLIC_KEY_PATH_WORK_DST\" file is already up to date."
    else
      cp "$SSH_PUBLIC_KEY_PATH_WORK_SRC" "$SSH_PUBLIC_KEY_PATH_WORK_DST"
