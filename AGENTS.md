...
One-way doors need 10x thought.
...
## `configs` Specific Instructions

- This is an open source Git repository for my personal configs.
- Run "lint.sh" after modifying any file.
